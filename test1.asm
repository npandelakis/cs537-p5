...
int main() {
  ...
  16:	6a 0e                	push   $0xe
  18:	6a 03                	push   $0x3
  1a:	68 a0 0f 00 00       	push   $0xfa0
  1f:	68 00 00 02 60       	push   $0x60020000
  24:	e8 6a 03 00 00       	call   393 <mmap>
    printf(1, "%p\n", mem);
  ...
  3e:	83 fb ff             	cmp    $0xffffffff,%ebx
  41:	74 3f                	je     82 <main+0x82>
        printf(1,"case 1\n");
	    goto failed;
    }
    if (mem != (void *)addr) {
  43:	81 fb 00 00 02 60    	cmp    $0x60020000,%ebx
  49:	74 24                	je     6f <main+0x6f>
        printf(1,"case 2\n");
  4b:	51                   	push   %ecx
  4c:	51                   	push   %ecx
...
failed:
  ...
  5c:	50                   	push   %eax
  5d:	50                   	push   %eax
  5e:	68 ab 07 00 00       	push   $0x7ab
  63:	6a 01                	push   $0x1
  65:	e8 f6 03 00 00       	call   460 <printf>
    exit();
  6a:	e8 84 02 00 00       	call   2f3 <exit>
    printf(1, "MMAP\t SUCCESS\n");
  6f:	52                   	push   %edx
  70:	52                   	push   %edx
  71:	68 9c 07 00 00       	push   $0x79c
  76:	6a 01                	push   $0x1
  78:	e8 e3 03 00 00       	call   460 <printf>
    exit();
  7d:	e8 71 02 00 00       	call   2f3 <exit>
        printf(1,"case 1\n");
  82:	53                   	push   %ebx
  83:	53                   	push   %ebx
  84:	68 8c 07 00 00       	push   $0x78c
  89:	6a 01                	push   $0x1
 ...
 469:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 5e7:	90                   	nop
          s = "(null)";
 5e8:	ba b9 07 00 00       	mov    $0x7b9,%edx
        while(*s != 0){
